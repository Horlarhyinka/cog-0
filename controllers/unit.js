...
const createUnit = async(req, res) => {
    ...
    try{
        ...
        await property.findByIdAndUpdate(propertyId, {$push: {units: savedUnit._id}}, {new: true} )
...
const updateUnit = async (req, res, next) => {
    try {
        const updatedUnit = await Unit.findByIdAndUpdate(req.params.id,{$set:req.body},{new:true})
